...
class VirtualMachineHandler(Iface):
    ...
    def prepare_security_groups_new_server(self, resenv: List[str], servername: str, http: bool = False, https: bool = False):
    ...
    def create_resenv_security_group_and_attach_to_server(self, server_id: str, resenv_template: str):
        ...
        if resenv_security_group:
            ...
            for sg in server_security_groups:
                if sg["name"] == resenv_security_group.name:
                    return
            LOG.info(f"Add {resenv_security_group} Security Groups to Instance: {server_id}")
