...
class VirtualMachineHandler(Iface):
    ...
    def add_udadd_udp_security_group(self, server_id):
        """
    ...
    def start_cluster(self, public_key, master_instance, worker_instances, user):
        ...
        body = {
            ...
            "ansibleGalaxyRoles": [{"name": "autoscaling-master", "hosts": "master",
                                    "git": "https://github.com/deNBI/autoscaling-cluster/tree/playbook-test/playbook/roles/master"},
                                   {"name": "autoscaling-worker", "hosts": "all",
                                    "git": "https://github.com/deNBI/autoscaling-cluster/tree/playbook-test/playbook/roles/common"}
                                   ]
        }
    ...
    def delete_server(self, openstack_id):
        ...
        try:
            ...
            if security_groups is not None:
                ...
                LOG.info(f"Failed to delete Server - {openstack_id}")

                return False
            LOG.info(f"Deleted Server - {openstack_id}")
            return True
        except ConflictException as e:
