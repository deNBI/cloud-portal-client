...
class CallbackModule(CallbackBase):
    ...
    def v2_playbook_on_stats(self, stats):
        self.logger.runtimee = datetime.now() - self.start_time
    ...
    def record_logs(self):
        ...
        fh = logging.FileHandler('log/ansible_playbook.log', delay=True)
        ...
        return logger.log(level=1000, msg=self.logger.log + str(self.logger.runtime))
