...
class start_cluster_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i242 in range(_size238):
                        _elem243 = ClusterInstance()
                        _elem243.read(iprot)
                        self.worker_instance.append(_elem243)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.worker_instance is not None:
            ...
            for iter244 in self.worker_instance:
                iter244.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class create_volume_args(object):
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter270, viter271 in self.metadata.items():
