            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i487 in range(_size483):
                        ...
                        _val489 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i512 in range(_size508):
                        ...
                        _val514 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i528 in range(_size524):
                        _key529 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i537 in range(_size533):
                        ...
                        _val539 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i546 in range(_size542):
                        _key547 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val548 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i555 in range(_size551):
                        ...
                        _val557 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            for kiter558, viter559 in self.metadata.items():
                ...
                oprot.writeString(viter559.encode('utf-8') if sys.version_info[0] == 2 else viter559)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter567, viter568 in self.success.items():
                oprot.writeString(kiter567.encode('utf-8') if sys.version_info[0] == 2 else kiter567)
