...
class Iface(object):
    ...
    def start_server_without_playbook(self, flavor, image, public_key, servername, metadata, https, http, resenv, volume_ids_path):
        """
        Parameters:
    ...
    def start_server_with_mounted_volume(self, flavor, image, public_key, servername, metadata, https, http, resenv, volume_ids_path):
        """
        Parameters:
         - flavor: Name of the  Flavor to use.
         - image: Name of the image to use.
    ...
    def start_server_with_custom_key(self, flavor, image, servername, metadata, http, https, resenv, volume_ids_path):
        """
...
class Client(Iface):
    ...
    def start_server_without_playbook(self, flavor, image, public_key, servername, metadata, https, http, resenv, volume_ids_path):
        ...
        """
        self.send_start_server_without_playbook(flavor, image, public_key, servername, metadata, https, http, resenv, volume_ids_path)
        return self.recv_start_server_without_playbook()

    def send_start_server_without_playbook(self, flavor, image, public_key, servername, metadata, https, http, resenv, volume_ids_path):
        ...
        args.http = http
        args.resenv = resenv
        args.volume_ids_path = volume_ids_path
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()
    ...
    def start_server_with_mounted_volume(self, flavor, image, public_key, servername, metadata, https, http, resenv, volume_ids_path):
        ...
        """
        self.send_start_server_with_mounted_volume(flavor, image, public_key, servername, metadata, https, http, resenv, volume_ids_path)
        return self.recv_start_server_with_mounted_volume()

    def send_start_server_with_mounted_volume(self, flavor, image, public_key, servername, metadata, https, http, resenv, volume_ids_path):
    ...
    def start_server_with_custom_key(self, flavor, image, servername, metadata, http, https, resenv, volume_ids_path):
        ...
        """
        self.send_start_server_with_custom_key(flavor, image, servername, metadata, http, https, resenv, volume_ids_path)
        return self.recv_start_server_with_custom_key()

    def send_start_server_with_custom_key(self, flavor, image, servername, metadata, http, https, resenv, volume_ids_path):
...
class Processor(Iface, TProcessor):
    ...
    def process_start_server_without_playbook(self, seqid, iprot, oprot):
        ...
        result = start_server_without_playbook_result()
        try:
            result.success = self._handler.start_server_without_playbook(args.flavor, args.image, args.public_key, args.servername, args.metadata, args.https, args.http, args.resenv, args.volume_ids_path)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
    ...
    def process_start_server_with_mounted_volume(self, seqid, iprot, oprot):
        ...
        result = start_server_with_mounted_volume_result()
        try:
            result.success = self._handler.start_server_with_mounted_volume(args.flavor, args.image, args.public_key, args.servername, args.metadata, args.https, args.http, args.resenv, args.volume_ids_path)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except nameException as e:
    ...
    def process_start_server_with_custom_key(self, seqid, iprot, oprot):
        ...
        result = start_server_with_custom_key_result()
        try:
            result.success = self._handler.start_server_with_custom_key(args.flavor, args.image, args.servername, args.metadata, args.http, args.https, args.resenv, args.volume_ids_path)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except nameException as e:
...
class start_server_without_playbook_args(object):
    ...
    def __init__(self, flavor=None, image=None, public_key=None, servername=None, metadata=None, https=None, http=None, resenv=None, volume_ids_path=None,):
        self.flavor = flavor
        self.image = image
        self.public_key = public_key
        self.servername = servername
        ...
        self.http = http
        self.resenv = resenv
        self.volume_ids_path = volume_ids_path
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i143 in range(_size139):
                        ...
                        iprot.readMapEnd()
                        self.volume_ids_path.append(_elem144)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter152, viter153 in self.metadata.items():
                oprot.writeString(kiter152.encode('utf-8') if sys.version_info[0] == 2 else kiter152)
                oprot.writeString(viter153.encode('utf-8') if sys.version_info[0] == 2 else viter153)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        ...
        if self.resenv is not None:
            ...
            for iter154 in self.resenv:
                oprot.writeString(iter154.encode('utf-8') if sys.version_info[0] == 2 else iter154)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.volume_ids_path is not None:
            oprot.writeFieldBegin('volume_ids_path', TType.LIST, 9)
            oprot.writeListBegin(TType.MAP, len(self.volume_ids_path))
            for iter155 in self.volume_ids_path:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter155))
                for kiter156, viter157 in iter155.items():
...
start_server_without_playbook_args.thrift_spec = (
    ...
    (9, TType.LIST, 'volume_ids_path', (TType.MAP, (TType.STRING, 'UTF8', TType.STRING, 'UTF8', False), False), None, ),  # 9
)
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter165, viter166 in self.success.items():
                ...
                oprot.writeString(viter166.encode('utf-8') if sys.version_info[0] == 2 else viter166)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
...
class start_server_with_mounted_volume_args(object):
                ...
                if ftype == TType.LIST:
                    ...
                    for _i184 in range(_size180):
                        ...
                        for _i190 in range(_size186):
                            ...
                            _elem185[_key191] = _val192
                        iprot.readMapEnd()
                        self.volume_ids_path.append(_elem185)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            oprot.writeFieldBegin('metadata', TType.MAP, 5)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter193, viter194 in self.metadata.items():
        ...
        if self.volume_ids_path is not None:
            oprot.writeFieldBegin('volume_ids_path', TType.LIST, 9)
            oprot.writeListBegin(TType.MAP, len(self.volume_ids_path))
            for iter196 in self.volume_ids_path:
...
class start_server_args(object):
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            oprot.writeFieldBegin('metadata', TType.MAP, 5)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter221, viter222 in self.metadata.items():
...
class start_server_with_custom_key_args(object):
    ...
    def __init__(self, flavor=None, image=None, servername=None, metadata=None, http=None, https=None, resenv=None, volume_ids_path=None,):
        self.flavor = flavor
        self.image = image
        self.servername = servername
        self.metadata = metadata
                ...
                if ftype == TType.LIST:
                    ...
                    for _i250 in range(_size246):
                        ...
                        for _i256 in range(_size252):
                            ...
                            _elem251[_key257] = _val258
                        iprot.readMapEnd()
                        self.volume_ids_path.append(_elem251)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter259, viter260 in self.metadata.items():
        ...
        if self.volume_ids_path is not None:
            oprot.writeFieldBegin('volume_ids_path', TType.LIST, 9)
            oprot.writeListBegin(TType.MAP, len(self.volume_ids_path))
            for iter262 in self.volume_ids_path:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter262))
                for kiter263, viter264 in iter262.items():
...
class create_and_deploy_playbook_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i278 in range(_size274):
                        ...
                        iprot.readMapEnd()
                        self.playbooks_information[_key279] = _val280
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.playbooks_information is not None:
            ...
            for kiter288, viter289 in self.playbooks_information.items():
                oprot.writeString(kiter288.encode('utf-8') if sys.version_info[0] == 2 else kiter288)
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(viter289))
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter326 in self.success:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter326))
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter349 in self.success:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter349))
                for kiter350, viter351 in iter349.items():
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i356 in range(_size352):
                        ...
                        _val358 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
...
class get_servers_by_ids_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i372 in range(_size368):
                        ...
                        self.server_ids.append(_elem373)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.server_ids is not None:
            ...
            for iter374 in self.server_ids:
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i393 in range(_size389):
                        ...
                        _val395 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter396, viter397 in self.success.items():
                ...
                oprot.writeString(viter397.encode('utf-8') if sys.version_info[0] == 2 else viter397)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i402 in range(_size398):
                        ...
                        self.base_tags.append(_elem403)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i409 in range(_size405):
                        _key410 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val411 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
...
class start_cluster_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i418 in range(_size414):
                        _elem419 = ClusterInstance()
                        _elem419.read(iprot)
                        self.worker_instance.append(_elem419)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.worker_instance is not None:
            ...
            for iter420 in self.worker_instance:
                iter420.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i425 in range(_size421):
                        _key426 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val427 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter428, viter429 in self.success.items():
                ...
                oprot.writeString(viter429.encode('utf-8') if sys.version_info[0] == 2 else viter429)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i434 in range(_size430):
                        _key435 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val436 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter437, viter438 in self.success.items():
                ...
                oprot.writeString(viter438.encode('utf-8') if sys.version_info[0] == 2 else viter438)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i443 in range(_size439):
                        _key444 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val445 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
...
class create_volume_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i452 in range(_size448):
                        ...
                        _val454 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.metadata[_key453] = _val454
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter455, viter456 in self.metadata.items():
...
class create_volume_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i461 in range(_size457):
                        _key462 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val463 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.MAP, 0)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.success))
            for kiter464, viter465 in self.success.items():
                oprot.writeString(kiter464.encode('utf-8') if sys.version_info[0] == 2 else kiter464)
                oprot.writeString(viter465.encode('utf-8') if sys.version_info[0] == 2 else viter465)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.r is not None:
            oprot.writeFieldBegin('r', TType.STRUCT, 1)
