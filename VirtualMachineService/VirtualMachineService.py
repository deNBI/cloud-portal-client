            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i208 in range(_size204):
                        _elem209 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                ...
                if ftype == TType.LIST:
                    ...
                    for _i296 in range(_size292):
                        ...
                        for _i302 in range(_size298):
                            ...
                            _val304 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                ...
                if ftype == TType.MAP:
                    ...
                    for _i340 in range(_size336):
                        ...
                        for _i347 in range(_size343):
                            ...
                            _val349 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i480 in range(_size476):
                        ...
                        _val482 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i496 in range(_size492):
                        ...
                        _val498 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i512 in range(_size508):
                        ...
                        _val514 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter515, viter516 in self.success.items():
                ...
                oprot.writeString(viter516.encode('utf-8') if sys.version_info[0] == 2 else viter516)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
