                ...
                if ftype == TType.MAP:
                    ...
                    for _i347 in range(_size343):
                        ...
                        for _i354 in range(_size350):
                            ...
                            _val356 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i395 in range(_size391):
                        _elem396 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i427 in range(_size423):
                        _elem428 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i450 in range(_size446):
                        ...
                        _val452 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                ...
                if ftype == TType.MAP:
                    ...
                    for _i494 in range(_size490):
                        ...
                        for _i501 in range(_size497):
                            _elem502 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter503, viter504 in self.success.items():
                ...
                oprot.writeListBegin(TType.STRING, len(viter504))
                for iter505 in viter504:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i519 in range(_size515):
                        _elem520 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.base_tags.append(_elem520)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i526 in range(_size522):
                        ...
                        _val528 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter529, viter530 in self.success.items():
                ...
                oprot.writeString(viter530.encode('utf-8') if sys.version_info[0] == 2 else viter530)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i535 in range(_size531):
                        _elem536 = ClusterInstance()
                        _elem536.read(iprot)
                        self.worker_instance.append(_elem536)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i551 in range(_size547):
                        ...
                        _val553 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i560 in range(_size556):
                        _key561 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val562 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
