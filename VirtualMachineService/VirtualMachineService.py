...
class Iface(object):
    ...
    def add_cluster_machine(self, cluster_id, cluster_user, cluster_group_id, image, flavor, name, key_name, batch_idx, worker_idx, pub_key, project_name, project_id, slurm_version):
        """
        Parameters:
         - cluster_id
         - cluster_user
    ...
    def start_cluster(self, public_keys, master_instance, worker_instance, user):
        """
        Parameters:
         - public_keys
         - master_instance
...
class Client(Iface):
    ...
    def add_server_metadata(self, server_id, metadata):
        ...
        """
        self.send_add_server_metadata(server_id, metadata)
    ...
    def recv_add_server_metadata(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = add_server_metadata_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.e is not None:
            raise result.e
    ...
    def recv_create_resenv_security_group_and_attach_to_server(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
    ...
    def add_cluster_machine(self, cluster_id, cluster_user, cluster_group_id, image, flavor, name, key_name, batch_idx, worker_idx, pub_key, project_name, project_id, slurm_version):
        ...
        """
        self.send_add_cluster_machine(cluster_id, cluster_user, cluster_group_id, image, flavor, name, key_name, batch_idx, worker_idx, pub_key, project_name, project_id, slurm_version)
        return self.recv_add_cluster_machine()

    def send_add_cluster_machine(self, cluster_id, cluster_user, cluster_group_id, image, flavor, name, key_name, batch_idx, worker_idx, pub_key, project_name, project_id, slurm_version):
    ...
    def start_cluster(self, public_keys, master_instance, worker_instance, user):
        ...
        """
        self.send_start_cluster(public_keys, master_instance, worker_instance, user)
        return self.recv_start_cluster()

    def send_start_cluster(self, public_keys, master_instance, worker_instance, user):
...
class Processor(Iface, TProcessor):
    ...
    def process_add_server_metadata(self, seqid, iprot, oprot):
        args = add_server_metadata_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = add_server_metadata_result()
        try:
            self._handler.add_server_metadata(args.server_id, args.metadata)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except serverNotFoundException as e:
    ...
    def process_add_cluster_machine(self, seqid, iprot, oprot):
        ...
        result = add_cluster_machine_result()
        try:
            result.success = self._handler.add_cluster_machine(args.cluster_id, args.cluster_user, args.cluster_group_id, args.image, args.flavor, args.name, args.key_name, args.batch_idx, args.worker_idx, args.pub_key, args.project_name, args.project_id, args.slurm_version)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
    ...
    def process_start_cluster(self, seqid, iprot, oprot):
        ...
        result = start_cluster_result()
        try:
            result.success = self._handler.start_cluster(args.public_keys, args.master_instance, args.worker_instance, args.user)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
...
class get_server_openstack_ids_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.filter_tag = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.filter_tag is not None:
            ...
            oprot.writeString(self.filter_tag.encode('utf-8') if sys.version_info[0] == 2 else self.filter_tag)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
get_server_openstack_ids_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'filter_tag', 'UTF8', None, ),  # 1
)
...
class add_server_metadata_args(object):
    """
    Attributes:
     - server_id
     - metadata
...
class add_server_metadata_result(object):
    """
    Attributes:
     - e
...
class create_resenv_security_group_and_attach_to_server_args(object):
    """
    Attributes:
     - server_id
     - resenv_template
...
class create_resenv_security_group_and_attach_to_server_result(object):
    """
    Attributes:
     - e
...
class add_cluster_machine_args(object):
    ...
    def __init__(self, cluster_id=None, cluster_user=None, cluster_group_id=None, image=None, flavor=None, name=None, key_name=None, batch_idx=None, worker_idx=None, pub_key=None, project_name=None, project_id=None, slurm_version=None,):
...
class start_cluster_args(object):
    ...
    def __init__(self, public_keys=None, master_instance=None, worker_instance=None, user=None,):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i528 in range(_size524):
                        ...
                        self.public_keys.append(_elem529)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i534 in range(_size530):
                        _elem535 = ClusterInstance()
                        _elem535.read(iprot)
                        self.worker_instance.append(_elem535)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.public_keys is not None:
            ...
            for iter536 in self.public_keys:
        ...
        if self.worker_instance is not None:
            ...
            for iter537 in self.worker_instance:
                iter537.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class start_cluster_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i542 in range(_size538):
                        _key543 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val544 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.success[_key543] = _val544
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.MAP, 0)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.success))
            for kiter545, viter546 in self.success.items():
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i551 in range(_size547):
                        ...
                        _val553 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter554, viter555 in self.success.items():
                ...
                oprot.writeString(viter555.encode('utf-8') if sys.version_info[0] == 2 else viter555)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter563, viter564 in self.success.items():
                oprot.writeString(kiter563.encode('utf-8') if sys.version_info[0] == 2 else kiter563)
                oprot.writeString(viter564.encode('utf-8') if sys.version_info[0] == 2 else viter564)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
...
class create_volume_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i569 in range(_size565):
                        ...
                        _val571 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.metadata[_key570] = _val571
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter572, viter573 in self.metadata.items():
...
class create_volume_result(object):
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.MAP, 0)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.success))
            for kiter581, viter582 in self.success.items():
