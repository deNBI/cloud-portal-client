...
class Client(Iface):
    ...
    def send_start_server_without_playbook(self, flavor, image, public_key, servername, metadata, https, http, resenv, volume_ids_path_new, volume_ids_path_attach):
    ...
    def scale_up_cluster(self, cluster_id, image, flavor, count, names, start_idx):
        ...
        """
        self.send_scale_up_cluster(cluster_id, image, flavor, count, names, start_idx)
        return self.recv_scale_up_cluster()

    def send_scale_up_cluster(self, cluster_id, image, flavor, count, names, start_idx):
...
class Processor(Iface, TProcessor):
    ...
    def process_start_server_without_playbook(self, seqid, iprot, oprot):
        ...
        result = start_server_without_playbook_result()
        try:
            result.success = self._handler.start_server_without_playbook(args.flavor, args.image, args.public_key, args.servername, args.metadata, args.https, args.http, args.resenv, args.volume_ids_path_new, args.volume_ids_path_attach)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
    ...
    def process_scale_up_cluster(self, seqid, iprot, oprot):
        ...
        result = scale_up_cluster_result()
        try:
            result.success = self._handler.scale_up_cluster(args.cluster_id, args.image, args.flavor, args.count, args.names, args.start_idx)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
...
class start_server_without_playbook_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i143 in range(_size139):
                        ...
                        iprot.readMapEnd()
                        self.volume_ids_path_new.append(_elem144)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 10:
                if ftype == TType.LIST:
                    ...
                    for _i156 in range(_size152):
                        ...
                        iprot.readMapEnd()
                        self.volume_ids_path_attach.append(_elem157)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter165, viter166 in self.metadata.items():
...
class start_server_with_mounted_volume_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i200 in range(_size196):
                        ...
                        for _i206 in range(_size202):
                            ...
                            _val208 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                            _elem201[_key207] = _val208
                        iprot.readMapEnd()
                        self.volume_ids_path_new.append(_elem201)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 10:
                if ftype == TType.LIST:
                    ...
                    for _i213 in range(_size209):
                        ...
                        iprot.readMapEnd()
                        self.volume_ids_path_attach.append(_elem214)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            oprot.writeFieldBegin('metadata', TType.MAP, 5)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter222, viter223 in self.metadata.items():
        ...
        if self.volume_ids_path_new is not None:
            oprot.writeFieldBegin('volume_ids_path_new', TType.LIST, 9)
            oprot.writeListBegin(TType.MAP, len(self.volume_ids_path_new))
            for iter225 in self.volume_ids_path_new:
        ...
        if self.volume_ids_path_attach is not None:
            oprot.writeFieldBegin('volume_ids_path_attach', TType.LIST, 10)
            oprot.writeListBegin(TType.MAP, len(self.volume_ids_path_attach))
            for iter228 in self.volume_ids_path_attach:
...
class start_server_args(object):
    ...
    def write(self, oprot):
        ...
        if self.resenv is not None:
            ...
            oprot.writeListBegin(TType.STRING, len(self.resenv))
            for iter255 in self.resenv:
                oprot.writeString(iter255.encode('utf-8') if sys.version_info[0] == 2 else iter255)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i260 in range(_size256):
                        _key261 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val262 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
...
class start_server_with_custom_key_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i276 in range(_size272):
                        _elem277 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.resenv.append(_elem277)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                if ftype == TType.LIST:
                    ...
                    for _i282 in range(_size278):
                        ...
                        iprot.readMapEnd()
                        self.volume_ids_path_new.append(_elem283)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 10:
                if ftype == TType.LIST:
                    ...
                    for _i295 in range(_size291):
                        ...
                        for _i301 in range(_size297):
                            ...
                            _elem296[_key302] = _val303
                        iprot.readMapEnd()
                        self.volume_ids_path_attach.append(_elem296)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter304, viter305 in self.metadata.items():
        ...
        if self.volume_ids_path_new is not None:
            oprot.writeFieldBegin('volume_ids_path_new', TType.LIST, 9)
            oprot.writeListBegin(TType.MAP, len(self.volume_ids_path_new))
            for iter307 in self.volume_ids_path_new:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter307))
                for kiter308, viter309 in iter307.items():
        ...
        if self.volume_ids_path_attach is not None:
            oprot.writeFieldBegin('volume_ids_path_attach', TType.LIST, 10)
            oprot.writeListBegin(TType.MAP, len(self.volume_ids_path_attach))
            for iter310 in self.volume_ids_path_attach:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter310))
                for kiter311, viter312 in iter310.items():
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i317 in range(_size313):
                        ...
                        _val319 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
...
class create_and_deploy_playbook_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i326 in range(_size322):
                        _key327 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val328 = {}
                        ...
                        for _i333 in range(_size329):
                            ...
                            _val328[_key334] = _val335
                        iprot.readMapEnd()
                        self.playbooks_information[_key327] = _val328
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.playbooks_information is not None:
            ...
            for kiter336, viter337 in self.playbooks_information.items():
                oprot.writeString(kiter336.encode('utf-8') if sys.version_info[0] == 2 else kiter336)
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(viter337))
                for kiter338, viter339 in viter337.items():
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.owner_id = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRING:
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i365 in range(_size361):
                        ...
                        _val367 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter368, viter369 in self.success.items():
                ...
                oprot.writeString(viter369.encode('utf-8') if sys.version_info[0] == 2 else viter369)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter399 in self.success:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter399))
                for kiter400, viter401 in iter399.items():
                ...
                if ftype == TType.LIST:
                    ...
                    for _i413 in range(_size409):
                        ...
                        for _i419 in range(_size415):
                            ...
                            _val421 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                            _elem414[_key420] = _val421
                        iprot.readMapEnd()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter422 in self.success:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter422))
                for kiter423, viter424 in iter422.items():
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i429 in range(_size425):
                        ...
                        _val431 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i445 in range(_size441):
                        ...
                        self.server_ids.append(_elem446)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class scale_up_cluster_args(object):
    ...
    def __init__(self, cluster_id=None, image=None, flavor=None, count=None, names=None, start_idx=None,):
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter482, viter483 in self.success.items():
                ...
                oprot.writeListBegin(TType.STRING, len(viter483))
                for iter484 in viter483:
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i489 in range(_size485):
                        ...
                        _val491 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter492, viter493 in self.success.items():
                ...
                oprot.writeString(viter493.encode('utf-8') if sys.version_info[0] == 2 else viter493)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class create_snapshot_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i498 in range(_size494):
                        ...
                        self.base_tags.append(_elem499)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.base_tags is not None:
            ...
            for iter500 in self.base_tags:
                oprot.writeString(iter500.encode('utf-8') if sys.version_info[0] == 2 else iter500)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i505 in range(_size501):
                        ...
                        _val507 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter508, viter509 in self.success.items():
                oprot.writeString(kiter508.encode('utf-8') if sys.version_info[0] == 2 else kiter508)
                oprot.writeString(viter509.encode('utf-8') if sys.version_info[0] == 2 else viter509)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class start_cluster_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i514 in range(_size510):
                        _elem515 = ClusterInstance()
                        _elem515.read(iprot)
                        self.worker_instance.append(_elem515)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.worker_instance is not None:
            ...
            for iter516 in self.worker_instance:
                iter516.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class terminate_cluster_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i530 in range(_size526):
                        _key531 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val532 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.MAP, 0)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.success))
            for kiter533, viter534 in self.success.items():
                oprot.writeString(kiter533.encode('utf-8') if sys.version_info[0] == 2 else kiter533)
...
class create_volume_args(object):
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter551, viter552 in self.metadata.items():
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i557 in range(_size553):
                        _key558 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val559 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.success[_key558] = _val559
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
