    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter355, viter356 in self.success.items():
                oprot.writeString(
                    kiter355.encode("utf-8") if sys.version_info[0] == 2 else kiter355
                )
                oprot.writeString(
                    viter356.encode("utf-8") if sys.version_info[0] == 2 else viter356
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter371, viter372 in self.success.items():
                oprot.writeString(
                    kiter371.encode("utf-8") if sys.version_info[0] == 2 else kiter371
                )
                oprot.writeString(
                    viter372.encode("utf-8") if sys.version_info[0] == 2 else viter372
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
