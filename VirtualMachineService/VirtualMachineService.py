        ...
        if self.success is not None:
            ...
            for iter260 in self.success:
                ...
                for kiter261, viter262 in iter260.items():
                    oprot.writeString(
                        kiter261.encode("utf-8")
                        if sys.version_info[0] == 2
                        else kiter261
                    )
                    oprot.writeString(
                        viter262.encode("utf-8")
                        if sys.version_info[0] == 2
                        else viter262
                    )
                oprot.writeMapEnd()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter270, viter271 in self.success.items():
                oprot.writeString(
                    kiter270.encode("utf-8") if sys.version_info[0] == 2 else kiter270
                )
                oprot.writeString(
                    viter271.encode("utf-8") if sys.version_info[0] == 2 else viter271
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
    ...
    def write(self, oprot):
        ...
        if self.server_ids is not None:
            ...
            for iter285 in self.server_ids:
                oprot.writeString(
                    iter285.encode("utf-8") if sys.version_info[0] == 2 else iter285
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter314, viter315 in self.success.items():
                oprot.writeString(
                    kiter314.encode("utf-8") if sys.version_info[0] == 2 else kiter314
                )
                oprot.writeString(
                    viter315.encode("utf-8") if sys.version_info[0] == 2 else viter315
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
