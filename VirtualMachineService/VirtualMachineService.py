...
class Iface(object):
    ...
    def start_server_with_custom_key(
        self, flavor, image, servername, metadata, http, https, resenv, volume_ids_path
    ):
        """
...
class Client(Iface):
    ...
    def start_server_with_custom_key(
        ...
        self.send_start_server_with_custom_key(
            flavor, image, servername, metadata, http, https, resenv, volume_ids_path
        )
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            for kiter152, viter153 in self.metadata.items():
                oprot.writeString(
                    kiter152.encode("utf-8") if sys.version_info[0] == 2 else kiter152
                )
                oprot.writeString(
                    viter153.encode("utf-8") if sys.version_info[0] == 2 else viter153
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        ...
        if self.resenv is not None:
            ...
            for iter154 in self.resenv:
                oprot.writeString(
                    iter154.encode("utf-8") if sys.version_info[0] == 2 else iter154
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.volume_ids_path is not None:
            ...
            for iter155 in self.volume_ids_path:
                ...
                for kiter156, viter157 in iter155.items():
                    oprot.writeString(
                        kiter156.encode("utf-8")
                        if sys.version_info[0] == 2
                        else kiter156
                    )
                    oprot.writeString(
                        viter157.encode("utf-8")
                        if sys.version_info[0] == 2
                        else viter157
                    )
                oprot.writeMapEnd()
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            for kiter193, viter194 in self.metadata.items():
                oprot.writeString(
                    kiter193.encode("utf-8") if sys.version_info[0] == 2 else kiter193
                )
                oprot.writeString(
                    viter194.encode("utf-8") if sys.version_info[0] == 2 else viter194
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.https is not None:
        ...
        if self.resenv is not None:
            ...
            for iter195 in self.resenv:
                oprot.writeString(
                    iter195.encode("utf-8") if sys.version_info[0] == 2 else iter195
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.volume_ids_path is not None:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter206, viter207 in self.success.items():
                oprot.writeString(
                    kiter206.encode("utf-8") if sys.version_info[0] == 2 else kiter206
                )
                oprot.writeString(
                    viter207.encode("utf-8") if sys.version_info[0] == 2 else viter207
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
    ...
    def write(self, oprot):
        ...
        if self.resenv is not None:
            ...
            for iter223 in self.resenv:
                oprot.writeString(
                    iter223.encode("utf-8") if sys.version_info[0] == 2 else iter223
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter231, viter232 in self.success.items():
                oprot.writeString(
                    kiter231.encode("utf-8") if sys.version_info[0] == 2 else kiter231
                )
                oprot.writeString(
                    viter232.encode("utf-8") if sys.version_info[0] == 2 else viter232
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
        ...
        if self.volume_ids_path is not None:
            ...
            for iter262 in self.volume_ids_path:
                ...
                for kiter263, viter264 in iter262.items():
                    oprot.writeString(
                        kiter263.encode("utf-8")
                        if sys.version_info[0] == 2
                        else kiter263
                    )
                    oprot.writeString(
                        viter264.encode("utf-8")
                        if sys.version_info[0] == 2
                        else viter264
                    )
                oprot.writeMapEnd()
    ...
    def write(self, oprot):
        ...
        if self.playbooks_information is not None:
            ...
            for kiter288, viter289 in self.playbooks_information.items():
                oprot.writeString(
                    kiter288.encode("utf-8") if sys.version_info[0] == 2 else kiter288
                )
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(viter289))
                for kiter290, viter291 in viter289.items():
                    oprot.writeString(
                        kiter290.encode("utf-8")
                        if sys.version_info[0] == 2
                        else kiter290
                    )
                    oprot.writeString(
                        viter291.encode("utf-8")
                        if sys.version_info[0] == 2
                        else viter291
                    )
                oprot.writeMapEnd()
        ...
        if self.success is not None:
            ...
            for iter326 in self.success:
                ...
                for kiter327, viter328 in iter326.items():
                    oprot.writeString(
                        kiter327.encode("utf-8")
                        if sys.version_info[0] == 2
                        else kiter327
                    )
                    oprot.writeString(
                        viter328.encode("utf-8")
                        if sys.version_info[0] == 2
                        else viter328
                    )
                oprot.writeMapEnd()
        ...
        if self.success is not None:
            ...
            for iter349 in self.success:
                ...
                for kiter350, viter351 in iter349.items():
                    oprot.writeString(
                        kiter350.encode("utf-8")
                        if sys.version_info[0] == 2
                        else kiter350
                    )
                    oprot.writeString(
                        viter351.encode("utf-8")
                        if sys.version_info[0] == 2
                        else viter351
                    )
                oprot.writeMapEnd()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter359, viter360 in self.success.items():
                oprot.writeString(
                    kiter359.encode("utf-8") if sys.version_info[0] == 2 else kiter359
                )
                oprot.writeString(
                    viter360.encode("utf-8") if sys.version_info[0] == 2 else viter360
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
    ...
    def write(self, oprot):
        ...
        if self.base_tags is not None:
            ...
            for iter404 in self.base_tags:
                oprot.writeString(
                    iter404.encode("utf-8") if sys.version_info[0] == 2 else iter404
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            for kiter455, viter456 in self.metadata.items():
                oprot.writeString(
                    kiter455.encode("utf-8") if sys.version_info[0] == 2 else kiter455
                )
                oprot.writeString(
                    viter456.encode("utf-8") if sys.version_info[0] == 2 else viter456
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter464, viter465 in self.success.items():
                oprot.writeString(
                    kiter464.encode("utf-8") if sys.version_info[0] == 2 else kiter464
                )
                oprot.writeString(
                    viter465.encode("utf-8") if sys.version_info[0] == 2 else viter465
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.r is not None:
