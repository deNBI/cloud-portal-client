    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            for kiter165, viter166 in self.metadata.items():
                oprot.writeString(
                    kiter165.encode("utf-8") if sys.version_info[0] == 2 else kiter165
                )
                oprot.writeString(
                    viter166.encode("utf-8") if sys.version_info[0] == 2 else viter166
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        ...
        if self.resenv is not None:
            ...
            for iter167 in self.resenv:
                oprot.writeString(
                    iter167.encode("utf-8") if sys.version_info[0] == 2 else iter167
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.volume_ids_path_new is not None:
            ...
            for iter168 in self.volume_ids_path_new:
                ...
                for kiter169, viter170 in iter168.items():
                    oprot.writeString(
                        kiter169.encode("utf-8")
                        if sys.version_info[0] == 2
                        else kiter169
                    )
                    oprot.writeString(
                        viter170.encode("utf-8")
                        if sys.version_info[0] == 2
                        else viter170
                    )
                oprot.writeMapEnd()
        ...
        if self.volume_ids_path_attach is not None:
            ...
            for iter171 in self.volume_ids_path_attach:
                ...
                for kiter172, viter173 in iter171.items():
                    oprot.writeString(
                        kiter172.encode("utf-8")
                        if sys.version_info[0] == 2
                        else kiter172
                    )
                    oprot.writeString(
                        viter173.encode("utf-8")
                        if sys.version_info[0] == 2
                        else viter173
                    )
                oprot.writeMapEnd()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter181, viter182 in self.success.items():
                oprot.writeString(
                    kiter181.encode("utf-8") if sys.version_info[0] == 2 else kiter181
                )
                oprot.writeString(
                    viter182.encode("utf-8") if sys.version_info[0] == 2 else viter182
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            for kiter222, viter223 in self.metadata.items():
                oprot.writeString(
                    kiter222.encode("utf-8") if sys.version_info[0] == 2 else kiter222
                )
                oprot.writeString(
                    viter223.encode("utf-8") if sys.version_info[0] == 2 else viter223
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.https is not None:
        ...
        if self.resenv is not None:
            ...
            for iter224 in self.resenv:
                oprot.writeString(
                    iter224.encode("utf-8") if sys.version_info[0] == 2 else iter224
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.volume_ids_path_new is not None:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter238, viter239 in self.success.items():
                oprot.writeString(
                    kiter238.encode("utf-8") if sys.version_info[0] == 2 else kiter238
                )
                oprot.writeString(
                    viter239.encode("utf-8") if sys.version_info[0] == 2 else viter239
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter263, viter264 in self.success.items():
                oprot.writeString(
                    kiter263.encode("utf-8") if sys.version_info[0] == 2 else kiter263
                )
                oprot.writeString(
                    viter264.encode("utf-8") if sys.version_info[0] == 2 else viter264
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            for kiter304, viter305 in self.metadata.items():
                oprot.writeString(
                    kiter304.encode("utf-8") if sys.version_info[0] == 2 else kiter304
                )
                oprot.writeString(
                    viter305.encode("utf-8") if sys.version_info[0] == 2 else viter305
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.http is not None:
        ...
        if self.resenv is not None:
            ...
            for iter306 in self.resenv:
                oprot.writeString(
                    iter306.encode("utf-8") if sys.version_info[0] == 2 else iter306
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.volume_ids_path_new is not None:
            ...
            for iter307 in self.volume_ids_path_new:
                ...
                for kiter308, viter309 in iter307.items():
                    oprot.writeString(
                        kiter308.encode("utf-8")
                        if sys.version_info[0] == 2
                        else kiter308
                    )
                    oprot.writeString(
                        viter309.encode("utf-8")
                        if sys.version_info[0] == 2
                        else viter309
                    )
                oprot.writeMapEnd()
        ...
        if self.volume_ids_path_attach is not None:
            ...
            for iter310 in self.volume_ids_path_attach:
                ...
                for kiter311, viter312 in iter310.items():
                    oprot.writeString(
                        kiter311.encode("utf-8")
                        if sys.version_info[0] == 2
                        else kiter311
                    )
                    oprot.writeString(
                        viter312.encode("utf-8")
                        if sys.version_info[0] == 2
                        else viter312
                    )
                oprot.writeMapEnd()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter320, viter321 in self.success.items():
                oprot.writeString(
                    kiter320.encode("utf-8") if sys.version_info[0] == 2 else kiter320
                )
                oprot.writeString(
                    viter321.encode("utf-8") if sys.version_info[0] == 2 else viter321
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
    ...
    def write(self, oprot):
        ...
        if self.playbooks_information is not None:
            ...
            for kiter336, viter337 in self.playbooks_information.items():
                oprot.writeString(
                    kiter336.encode("utf-8") if sys.version_info[0] == 2 else kiter336
                )
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(viter337))
                for kiter338, viter339 in viter337.items():
                    oprot.writeString(
                        kiter338.encode("utf-8")
                        if sys.version_info[0] == 2
                        else kiter338
                    )
                    oprot.writeString(
                        viter339.encode("utf-8")
                        if sys.version_info[0] == 2
                        else viter339
                    )
                oprot.writeMapEnd()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter368, viter369 in self.success.items():
                oprot.writeString(
                    kiter368.encode("utf-8") if sys.version_info[0] == 2 else kiter368
                )
                oprot.writeString(
                    viter369.encode("utf-8") if sys.version_info[0] == 2 else viter369
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter376 in self.success:
                oprot.writeString(
                    iter376.encode("utf-8") if sys.version_info[0] == 2 else iter376
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        ...
        if self.success is not None:
            ...
            for iter399 in self.success:
                ...
                for kiter400, viter401 in iter399.items():
                    oprot.writeString(
                        kiter400.encode("utf-8")
                        if sys.version_info[0] == 2
                        else kiter400
                    )
                    oprot.writeString(
                        viter401.encode("utf-8")
                        if sys.version_info[0] == 2
                        else viter401
                    )
                oprot.writeMapEnd()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter408 in self.success:
                oprot.writeString(
                    iter408.encode("utf-8") if sys.version_info[0] == 2 else iter408
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        ...
        if self.success is not None:
            ...
            for iter422 in self.success:
                ...
                for kiter423, viter424 in iter422.items():
                    oprot.writeString(
                        kiter423.encode("utf-8")
                        if sys.version_info[0] == 2
                        else kiter423
                    )
                    oprot.writeString(
                        viter424.encode("utf-8")
                        if sys.version_info[0] == 2
                        else viter424
                    )
                oprot.writeMapEnd()
    ...
    def write(self, oprot):
        ...
        if self.server_ids is not None:
            ...
            for iter447 in self.server_ids:
                oprot.writeString(
                    iter447.encode("utf-8") if sys.version_info[0] == 2 else iter447
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter482, viter483 in self.success.items():
                oprot.writeString(
                    kiter482.encode("utf-8") if sys.version_info[0] == 2 else kiter482
                )
                oprot.writeListBegin(TType.STRING, len(viter483))
                for iter484 in viter483:
                    oprot.writeString(
                        iter484.encode("utf-8") if sys.version_info[0] == 2 else iter484
                    )
                oprot.writeListEnd()
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter492, viter493 in self.success.items():
                oprot.writeString(
                    kiter492.encode("utf-8") if sys.version_info[0] == 2 else kiter492
                )
                oprot.writeString(
                    viter493.encode("utf-8") if sys.version_info[0] == 2 else viter493
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
    ...
    def write(self, oprot):
        ...
        if self.base_tags is not None:
            ...
            for iter500 in self.base_tags:
                oprot.writeString(
                    iter500.encode("utf-8") if sys.version_info[0] == 2 else iter500
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter508, viter509 in self.success.items():
                oprot.writeString(
                    kiter508.encode("utf-8") if sys.version_info[0] == 2 else kiter508
                )
                oprot.writeString(
                    viter509.encode("utf-8") if sys.version_info[0] == 2 else viter509
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter524, viter525 in self.success.items():
                oprot.writeString(
                    kiter524.encode("utf-8") if sys.version_info[0] == 2 else kiter524
                )
                oprot.writeString(
                    viter525.encode("utf-8") if sys.version_info[0] == 2 else viter525
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter533, viter534 in self.success.items():
                oprot.writeString(
                    kiter533.encode("utf-8") if sys.version_info[0] == 2 else kiter533
                )
                oprot.writeString(
                    viter534.encode("utf-8") if sys.version_info[0] == 2 else viter534
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter542, viter543 in self.success.items():
                oprot.writeString(
                    kiter542.encode("utf-8") if sys.version_info[0] == 2 else kiter542
                )
                oprot.writeString(
                    viter543.encode("utf-8") if sys.version_info[0] == 2 else viter543
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            for kiter551, viter552 in self.metadata.items():
                oprot.writeString(
                    kiter551.encode("utf-8") if sys.version_info[0] == 2 else kiter551
                )
                oprot.writeString(
                    viter552.encode("utf-8") if sys.version_info[0] == 2 else viter552
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter560, viter561 in self.success.items():
                oprot.writeString(
                    kiter560.encode("utf-8") if sys.version_info[0] == 2 else kiter560
                )
                oprot.writeString(
                    viter561.encode("utf-8") if sys.version_info[0] == 2 else viter561
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.r is not None:
