            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i265 in range(_size261):
                        ...
                        self.base_tags.append(_elem266)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
...
class start_cluster_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i281 in range(_size277):
                        _elem282 = ClusterInstance()
                        _elem282.read(iprot)
                        self.worker_instance.append(_elem282)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.worker_instance is not None:
            ...
            for iter283 in self.worker_instance:
                iter283.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class create_volume_args(object):
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter309, viter310 in self.metadata.items():
