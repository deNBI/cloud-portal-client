    ...
    def write(self, oprot):
        ...
        if self.names is not None:
            ...
            for iter489 in self.names:
                oprot.writeString(
                    iter489.encode("utf-8") if sys.version_info[0] == 2 else iter489
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.success is not None:
            ...
            for kiter503, viter504 in self.success.items():
                ...
                for iter505 in viter504:
                    oprot.writeString(
                        iter505.encode("utf-8") if sys.version_info[0] == 2 else iter505
                    )
                oprot.writeListEnd()
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter513, viter514 in self.success.items():
                oprot.writeString(
                    kiter513.encode("utf-8") if sys.version_info[0] == 2 else kiter513
                )
                oprot.writeString(
                    viter514.encode("utf-8") if sys.version_info[0] == 2 else viter514
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
    ...
    def write(self, oprot):
        ...
        if self.base_tags is not None:
            ...
            for iter521 in self.base_tags:
                oprot.writeString(
                    iter521.encode("utf-8") if sys.version_info[0] == 2 else iter521
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter529, viter530 in self.success.items():
                oprot.writeString(
                    kiter529.encode("utf-8") if sys.version_info[0] == 2 else kiter529
                )
                oprot.writeString(
                    viter530.encode("utf-8") if sys.version_info[0] == 2 else viter530
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
