                ...
                if ftype == TType.LIST:
                    ...
                    for _i365 in range(_size361):
                        ...
                        for _i371 in range(_size367):
                            _key372 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                            _val373 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter374 in self.success:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter374))
                for kiter375, viter376 in iter374.items():
                ...
                if ftype == TType.LIST:
                    ...
                    for _i388 in range(_size384):
                        ...
                        for _i394 in range(_size390):
                            ...
                            _val396 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                            _elem389[_key395] = _val396
                        iprot.readMapEnd()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter397 in self.success:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter397))
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i420 in range(_size416):
                        ...
                        self.server_ids.append(_elem421)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i450 in range(_size446):
                        ...
                        self.base_tags.append(_elem451)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
...
class start_cluster_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i466 in range(_size462):
                        _elem467 = ClusterInstance()
                        _elem467.read(iprot)
                        self.worker_instance.append(_elem467)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.worker_instance is not None:
            ...
            for iter468 in self.worker_instance:
                iter468.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i473 in range(_size469):
                        ...
                        _val475 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i482 in range(_size478):
                        ...
                        _val484 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter485, viter486 in self.success.items():
                ...
                oprot.writeString(viter486.encode('utf-8') if sys.version_info[0] == 2 else viter486)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class attach_volume_to_server_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i491 in range(_size487):
                        _key492 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val493 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.MAP, 0)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.success))
            for kiter494, viter495 in self.success.items():
...
class create_volume_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i500 in range(_size496):
                        ...
                        _val502 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.metadata[_key501] = _val502
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter503, viter504 in self.metadata.items():
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i509 in range(_size505):
                        _key510 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val511 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
