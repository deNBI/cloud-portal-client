...
class OpenStackConnector:
    ...
    def __init__(
        ...
        self.UDP_MULTIPLICATION_PORT = 3
        ...
        try:
            ...
            logger.exception("Client failed authentication at Openstack!")
    ...
    def load_config_yml(self, config_file):
        logger.info("Load config file openstack config")
        with open(config_file, "r") as ymlfile:
            ...
            self.REDIS_HOST = cfg["redis"]["redis_host"]
            self.REDIS_PORT = cfg["redis"]["redis_port"]
    ...
    def create_add_keys_script(self, keys):
        logger.info(f"create add key script")
    ...
    def get_image(self, name_or_id, replace_inactive=False):
        ...
        if image and image.status != "active" and replace_inactive:
            ...
            raise imageNotFoundException(Reason=(f"Image {name_or_id} found but not active!"))
        return util.convert_openstack_to_thrift_image(openstack_image=image)
    ...
    def get_public_images(self):
        ...
        if self.openstack_connection:
            ...
            return util.convert_openstack_to_thrift_images(openstack_images=images)
    ...
    def prepare_security_groups_new_server(self, research_environment_metadata, servername):
    ...
    def delete_server(self, openstack_id):
        ...
        try:
            ...
            security_groups = [
                ...
                if sec["name"] != DEFAULT_SECURITY_GROUP
    ...
    def start_server(
        ...
        custom_security_groups = self.prepare_security_groups_new_server(
            research_environment_metadata=research_environment_metadata, servername=servername
        )
        key_name = None
        try:
            ...
            server = self.openstack_connection.create_server(
                ...
                availability_zone=self.AVAILABILITY_ZONE,
                security_groups=DEFAULT_SECURITY_GROUPS + custom_security_groups,
            )
    ...
    def check_server_status(self, openstack_id):
        ...
        try:
            ...
            logger.exception(f"Check Status VM {openstack_id} failed")
