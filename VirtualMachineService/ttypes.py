...
class Flavor(object):
    ...
    def __init__(self, vcpus=None, ram=None, disk=None, name=None, openstack_id=None, description=None, tags=None, ephemeral_disk=None,):
        self.vcpus = vcpus
        self.ram = ram
        self.disk = disk
        self.name = name
...
class VM(object):
    ...
    def __init__(self, flavor=None, image=None, status=None, metadata=None, project_id=None, keyname=None, openstack_id=None, name=None, created_at=None, floating_ip=None, fixed_ip=None, diskspace=None, volume_id=None, task_state=None, power_state=None, vm_state=None,):
        self.flavor = flavor
        self.image = image
        self.status = status
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.power_state = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 16:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        ...
        if self.task_state is not None:
            oprot.writeFieldBegin('task_state', TType.STRING, 14)
        ...
        if self.power_state is not None:
            oprot.writeFieldBegin('power_state', TType.STRING, 15)
            oprot.writeString(self.power_state.encode('utf-8') if sys.version_info[0] == 2 else self.power_state)
            oprot.writeFieldEnd()
        if self.vm_state is not None:
            oprot.writeFieldBegin('vm_state', TType.STRING, 16)
...
VM.thrift_spec = (
    ...
    (14, TType.STRING, 'task_state', 'UTF8', None, ),  # 14
    (15, TType.STRING, 'power_state', 'UTF8', None, ),  # 15
    (16, TType.STRING, 'vm_state', 'UTF8', None, ),  # 16
)
